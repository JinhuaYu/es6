...
/***/ (function(module, exports, __webpack_require__) {
	...
	function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } } // 功能集合
	...
	var Base = function () {
	  ...
	  _createClass(Base, [{
	    ...
	    value: function getCount() {
	      ...
	      var count = self.computeCount(active, self.cur_play);
	      var range = self.computeCount(active, self.cur_play);
	      var money = count * 2;
	    ...
	    value: function getRandomCode(e) {
	      ...
	      if (num === '0') {
	        ...
	        for (var i = 0; i < num; i++) {
	          self.addCodeItem(self.getRandom(play), self.cur_play, self.play_list.get(self.cur_play).name);
	        }
	      }
	    }
	  }]);
